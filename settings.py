...
# Physique
GRAVITY = 1  # Accélération de pesanteur exprimée en pixels par frame²
MAX_VERT_SPEED = 15  # Vitesse verticale maximale exprimée en pixels par frame

# Attributs personnages
